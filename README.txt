...
Version 2.0
==================================================================
Ken Snyder, building on the datasets and files from the following:
...
dataset has been randomly partitioned into two sets, where 70% of the volunteers was 
...
The following two files were added by Ken Snyder for subject/activity mean analysis:

- 'combined_tidy.txt': Combined test and training data sets in tidy form.

- 'subject_activity_mean.txt': Tidy dataset of the combined_tidy.txt with mean values for eash subject and activity.

The following script, written by Ken Snyder, creates the above two analysis files.
